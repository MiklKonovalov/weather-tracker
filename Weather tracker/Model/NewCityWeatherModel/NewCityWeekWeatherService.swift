...
final class NewCityWeekWeatherService {
    ...
    func weatherURLString(coordinatesOne: Double, coordinatesTwo: Double) -> String {
        return "https://api.openweathermap.org/data/2.5/onecall?lat=\(coordinatesOne)&lon=\(coordinatesTwo)&exclude=hourly&units=metric&appid=b382e4a70dfb690b16b9381daac545ac&lang=ru"
    }
