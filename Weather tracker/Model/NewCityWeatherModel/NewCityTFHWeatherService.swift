...
final class NewCityTFHWeatherService {
    ...
    func weatherURLString(coordinatesOne: Double, coordinatesTwo: Double) -> String {
        return "https://api.openweathermap.org/data/2.5/forecast?lat=\(coordinatesOne)&lon=\(coordinatesTwo)&cnt=7&units=metric&appid=04865a1fa3d5d2578d52f3d8970c7bf9&lang=ru"
    }
